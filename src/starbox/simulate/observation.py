...
class Observation:
    ...
    @property
    def phase_center_radians(self) -> tuple[float, float]:
    ...
    @property
    def pointing_center_radians(self) -> tuple[float, float]:
    ...
    @property
    def times_sidereal(self) -> np.array:
        """Return the times converted to sidereal time."""
